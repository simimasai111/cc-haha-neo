#!/usr/bin/env pwsh
# cc-haha-neo mirrored Bun installer for Windows
# This is a fork of https://bun.sh/install.ps1 that downloads Bun releases
# through github.tbedu.top mirror to improve accessibility in some networks.
...
function Install-Bun {
 ...
 # Mirrored download URL for cc-haha-neo
 $BaseURL = "https://github.tbedu.top/https://github.com/oven-sh/bun/releases"
